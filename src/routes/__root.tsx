...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Skin Lab Med Spa — Advanced Aesthetics in Charlotte, NC" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Skin Lab Med Spa — Advanced Aesthetics in Charlotte, NC" },
      {
        ...
        content:
          "Reclaim your radiance with a personalized aesthetic plan. Premium injectables, non-invasive lifting, and medical-grade skincare in Charlotte, NC.",
      },
